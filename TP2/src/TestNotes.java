public class TestNotes {
    public static void main(String[] args) {
        ...
        System.out.println("La moyenne de l’Étudiant numéro : " + e1.getNum() + ", " + e1.getNom() + ", " + e1.getPrenom() + " est : " + moy);
        
        moy = (note[1][0] * 45 + note[1][1] * 50 + note[1][2] * 15) /110 ;
        System.out.println("La moyenne de l’Étudiant numéro : " + e2.getNum() + ", " + e2.getNom() + ", " + e2.getPrenom() + " est : " + moy);
